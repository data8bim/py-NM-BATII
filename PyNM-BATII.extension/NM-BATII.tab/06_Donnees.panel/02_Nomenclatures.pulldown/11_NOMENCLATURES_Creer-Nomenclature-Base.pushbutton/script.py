...
class CreateSchedulesWindow(WPFWindow):
    def __init__(self):
        ...
        try:
            ...
            forms.alert("Erreur chargement interface.", title="Erreur XAML")
            raise
        ...
        try:
            ...
            forms.alert("Erreur initialisation interface.", title="Erreur FindName")
            raise
    ...
    def show_dialog(self):
        try:
            ...
            forms.alert("Erreur affichage interface: {}".format(str(e)), title="Erreur ShowDialog")
            raise
        return self.result
