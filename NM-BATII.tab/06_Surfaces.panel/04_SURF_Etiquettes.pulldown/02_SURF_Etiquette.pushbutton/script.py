...
#__title__ = 'Étiqueter une surface'
...
# Récupère l'ID de la commande native "Étiquette de surface"
# (Architecture > Pièce et surface > Étiqueter une surface)
cmd_id = RevitCommandId.LookupPostableCommandId(PostableCommand.AreaTag)
