...
# inexistant) : l'import echouait TOUJOURS et show_alert retombait sur le
# fallback. _charger_styles() place les cles NMButton*/NMWindow* dans
# Application.Resources — indispensable aux fenetres locales et a show_alert.
try:
...
# ─── Tableau de mappages partage (lib/dialogs/mapping_table.py) ──────────────
# Modele de ligne (MappingRow, avec son etat « Actif ») + presentation en
# tableau : en-tetes tri/filtre/reinitialisation, barre d'outils, cases a
# cocher. Meme ergonomie que « NM-BATII — Selection des vues a traiter ».
...
def main():
    ...
    table = MappingTableView(
        wpf, row_list,
        label_source=u'Paramètre source (Informations Projet)',
