...
# Récupère l'ID de la commande native "Étiquette de pièce"
# (Architecture > Pièce et surface > Étiqueter une pièce)
cmd_id = RevitCommandId.LookupPostableCommandId(PostableCommand.RoomTag)
