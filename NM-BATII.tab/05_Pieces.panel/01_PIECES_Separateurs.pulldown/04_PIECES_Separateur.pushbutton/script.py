...
#__title__ = 'Séparateur de pièces'
...
# Récupère l'ID de la commande native "Séparateur de pièces"
# (Architecture > Pièce et surface > Séparateur de pièces)
cmd_id = RevitCommandId.LookupPostableCommandId(PostableCommand.RoomSeparator)
